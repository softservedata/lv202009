...
//                "./lib/geckodriver.exe");
        ...
        FirefoxProfile profile = new FirefoxProfile(new File(
                // "C:\\Users\\sfirso\\AppData\\Roaming\\Mozilla\\Firefox\\Profiles\\3pu2lzgu.default"));
                System.getenv("HOMEPATH")
                        + "\\AppData\\Roaming\\Mozilla\\Firefox\\Profiles\\elmn0sc5.default-release"));
        //
...
//                "./lib/geckodriver.exe");
        ...
        //
        driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
        driver.get("https://192.168.3.1/Index#/Home"); //IPv4 DNS server
        Thread.sleep(2000);
        takeScreenShot(driver);
        driver.quit();
    }
...
//                this.getClass().getResource("/chromedriver-windows-32bit.exe").getPath());
        ...
        element.submit();
        Actions action = new Actions(driver);
        action.moveToElement(driver.findElement(By.id("gfn"))).perform();
        Thread.sleep(2000);
        takeScreenShot(driver);
        driver.quit();
    }
...
.usingDriverExecutable(new File("C:\\Users\\sfirso\\.cache\\selenium\\chromedriver\\win32\\87.0.4280.20\\chromedriver.exe"))
