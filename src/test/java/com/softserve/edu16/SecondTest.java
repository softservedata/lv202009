...
public class SecondTest {
	...
	public void checkRefreshElement() {
		 ...
		 * email.click(); email.clear(); email.sendKeys("hahaha"); String content =
		 * email.getAttribute("value"); System.out.println("content email = " +
		 * content); presentationSleep(); // For Presentation ONLY // // Refresh some
		 * webelements driver.navigate().refresh(); presentationSleep(); // For
		 * Presentation ONLY // email.sendKeys("bebebe"); presentationSleep(); // For
		 * Presentation ONLY
		 */
		//
