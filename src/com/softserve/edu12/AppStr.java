...
public class AppStr {
	public static void main(String[] args) {
		...
		*/
		/*-
		String str = "I study Java Kava language abcd";
		...
		String str2 = str.substring(8, 13); // 8-12 "Java "
		...
		*/
		...
		System.out.println(str);
		//str = str.replace("a", "--");
		str = str.replaceAll("a\\b|\\ba", "--"); // \b word boundary
		...
		*/
		/*
		 * String a = "a"; // What will be the results? String A = "A"; String b = "a";
