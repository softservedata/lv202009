...
public class Appl {
	...
	public static void main(String[] args) {
		Product[] products = { new Coffee(5, 20), new Wine(WineCountry.SPAIN, 300), new Product("Water", 20),
				new Wine(WineCountry.SPAIN, 400), new Coffee(8, 40), new Product("Bear", 50), new Product("Milk", 20),
				new Coffee(8, 30), new Wine(WineCountry.FRANCE, 300), new Product("Bear", 50), new Product("Milk", 10),
				new Coffee(8, 50), new Wine(WineCountry.SPAIN, 200) };
		//
